...
{
    public class UltimateUrlPickerPreValueEditor : PreValueEditor
    {
        public UltimateUrlPickerPreValueEditor()
        {
            //create the fields
            Fields.Add(new PreValueField()
            {
                ...
                Key = "allowedmodes",
                View = "/app_plugins/UltimateUrlPicker/prevalues/allowedmodes.html",
                Name = "Allowed modes",
            });
            ...
            Fields.Add(new PreValueField()
            {
                ...
                Key = "defaultmode",
                View = "/app_plugins/UltimateUrlPicker/prevalues/defaultmode.html",
                Name = "Default mode",
            });
            ...
            Fields.Add(new PreValueField()
            {
                ...
                Key = "dataformat",
                View = "/app_plugins/UltimateUrlPicker/prevalues/dataformat.html",
                Name = "Data format",
            });
